...
public class SNMPManager {
    ...
    public static void main(String[] args) throws IOException {
        ...
        SNMPManager client = new SNMPManager("udp:192.168.1.99/161");
        client.start();
        /**
        ...
        String sysDescr = client.getAsString(new OID(".1.3.6.1.4.1.161.19.2112.1.3.1"));
        //String sysDescr = client.getAsString(new OID(".1.3.6.1.2.1.2.2"));
        //String sysDescr = client.getAsString(new OID(".1.3.6.1.4.1.2162.4.9.1"));
        //String sysDescr = client.getAsString(new OID(".1.3.6.1.4.1.161.19.2112.1.1.3"));
